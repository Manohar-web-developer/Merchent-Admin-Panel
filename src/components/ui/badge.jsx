  ...
  "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 select-none",
  {
    variants: {
      variant: {
        ...
        active:
          "bg-[#EBFDF3] text-[#027A48] border border-[#ABEFC6] dark:bg-emerald-950/50 dark:text-emerald-400 dark:border-emerald-800/50",
        inactive:
          "bg-[#FEF3F2] text-[#B42318] border border-[#FECDCA] dark:bg-rose-950/50 dark:text-rose-400 dark:border-rose-800/50",
      },
    },
    defaultVariants: {
      variant: "default",
